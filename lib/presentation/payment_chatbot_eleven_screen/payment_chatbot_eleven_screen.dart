import '../payment_chatbot_eleven_screen/widgets/listframethree_one_item_widget.dart';
...
class PaymentChatbotElevenScreen
    extends GetWidget<PaymentChatbotElevenController> {
  @override
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CommonImageView(
                                          svgPath: ImageConstant.imgVolume55X24,
                                          height: getVerticalSize(
                                            55.00,
                                          ),
                                          width: getHorizontalSize(
                                        ...
                                        CommonImageView(
                                          svgPath: ImageConstant.imgPlay55X24,
                                          height: getVerticalSize(
                                            55.00,
                                          ),
                                          width: getHorizontalSize(
                                    ...
                                    child: Obx(
                                      () => ListView.builder(
                                        ...
                                        itemCount: controller
                                            .paymentChatbotElevenModelObj
                                            .value
                                            .listframethreeOneItemList
                                            .length,
                                        itemBuilder: (context, index) {
                                          ListframethreeOneItemModel model =
                                              controller
                                                  .paymentChatbotElevenModelObj
                                                  .value
                                                  .listframethreeOneItemList[index];
                                          return ListframethreeOneItemWidget(
                                            model,
                                          );
                                        },
                                      ),
