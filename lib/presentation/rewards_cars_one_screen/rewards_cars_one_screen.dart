import '../rewards_cars_one_screen/widgets/listcalendar_item_widget.dart';
...
class RewardsCarsOneScreen extends GetWidget<RewardsCarsOneController> {
  @override
                                        ...
                                        child: Obx(
                                          () => ListView.separated(
                                            ...
                                            itemCount: controller
                                                .rewardsCarsOneModelObj
                                                .value
                                                .listcalendarItemList
                                                .length,
                                            itemBuilder: (context, index) {
                                              ListcalendarItemModel model =
                                                  controller
                                                          .rewardsCarsOneModelObj
                                                          .value
                                                          .listcalendarItemList[
